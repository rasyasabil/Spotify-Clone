            ...
            <div className='grid grid-cols-2'>
                <div className='space-y-4'>
                    ...
                    <div className='h-64 pr-8'>
                        <div className='text-white cursor-pointer relative group h-64 w-full bg-neutral-800 hover:bg-neutral-700 p-4 flex flex-col gap-6 rounded-md transition duration-500'>
                            ...
                            {playlists && <><img className='h-28 w-28 rounded text-white' src={playlists[0].images[0].url} />
                ...
                <div className='space-y-4'>
                    <h2 className='text-xl font-bold text-white'>Top song</h2>
